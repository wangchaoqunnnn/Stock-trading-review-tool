...
ENDPOINTS = ["snapshot", "preopen", "realtime", "volprice", "pullback", "flow3", "trend3", "limit20", "ztpool", "hot", "breakout", "leaders", "heatmap", "emotion_history", "speedrank", "pullback_ma", "support_valid", "review", "globalmac", "trading", "tactics"]
